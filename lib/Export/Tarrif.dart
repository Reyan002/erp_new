...
class Tariff extends StatefulWidget {
  @override
  _TariffState createState() => _TariffState();
}

class _TariffState extends State<Tariff> {
  int inc = 0;
  int incKg = 0;
  Users _currentUser;
...
//              )
              ...
              ,
              FlatButton.icon(onPressed: _addItem, icon: Icon(Icons.add), label: Text("ADD ANOTHER CONTAINER TYPE"))
              ,
              Padding(
                padding:
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: RaisedButton(
                    onPressed: (){},
                    child: Text("LOOK UP",style: TextStyle(color: Colors.white),),
